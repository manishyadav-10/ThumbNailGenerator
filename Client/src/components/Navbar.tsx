        ...
        <>
            ...
            >
                ...
                <div className="hidden md:flex items-center gap-8 transition duration-500">
                    ...
                    <Link to="/" className="hover:text-pink-00 3transition">
                        Home
                    </Link>
                    <Link to="/generate" className="hover:text-pink-00 3transition">
                        Generate
                    </Link>
                    {
                    ...
                    <Link to="/contact" className="hover:text-pink-00 3transition">
                        Contact us
                    </Link>
            ...
            <div className={`fixed inset-0 z-100 bg-black/40 backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-400 ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
                ...
                {isLoggedIn ? <Link onClick={() => setIsOpen(false)} to="/my-generation" >
                    My Generations
                </Link> : <Link onClick={() => setIsOpen(false)} to="/about" >
                    About
                </Link> 
                }
                ...
                ? <button onClick={()=>{setIsOpen(false); logout()}}>
                    Logout
                </button>  :  <Link onClick={() => setIsOpen(false)} to="/login" >
                    Login
                </Link>}
