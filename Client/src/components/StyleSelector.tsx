...
const StyleSelector = ({value, onChange, isOpen, setIsOpen} :
    {value:ThumbnailStyle; onChange:(style:ThumbnailStyle)=>void;
       ...
       const styleDescriptions: Record<ThumbnailStyle, string>={
        ...
        "Illustrated": "Hand-drawn or digitally illustrated elements with artistic flair.",
        "Tech/Futuristic": "Sleek, modern designs with neon accents and tech-inspired visuals.",
       } 
    ...
    <div className="relative space-y-3 dark">
       ...
       <button type="button" onClick={()=>setIsOpen(!isOpen)}
        ...
        <div className="space-y-1">
            ...
            <p className="text-sm text-zinc-400">{styleDescriptions[value]}</p>
        </div>
